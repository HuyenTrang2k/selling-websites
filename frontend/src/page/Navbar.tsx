...
const Navbar = () => {
  ...
  return (
    <Disclosure as='nav' className='bg-while flex'>
      {({ open }) => (
        <>
                  ...
                  <div>
                    <Menu.Button className='flex rounded-full border-0 text-sm'>
                      ...
                      <img
                        ...
                        src='https://scontent.fsgn1-1.fna.fbcdn.net/v/t39.30808-6/334543223_102662236096455_4398439125374420722_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=174925&_nc_ohc=e6EPRssRtiQAX-zUzv7&_nc_ht=scontent.fsgn1-1.fna&oh=00_AfDazGdMvyAjZVq1dHAYr28Ryu2Kj99UAwJT_z6KKHNXSg&oe=64450CEF'
                        alt=''
                      />
                    </Menu.Button>
                  </div>
